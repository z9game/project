...
<head>
<meta charset="UTF-8">
<title>RecruitMemBoardDetailForm</title>
<link href="/style/recruitMemBoardDetailFormStyle.css" rel="stylesheet">
</head>
<body>
	<%@ include file="/WEB-INF/jsp/header.jsp" %>
    <div class="recruitMemBoardDetailFormTitle">
    	<img src="/image/RecruitTitleBackgroundImage.jpg" class="titleBackgoundImg">
    	<p class="titleBackgoundText">팀원 모집</p>
    </div>
	...
	<c:if test="${empty requestScope.memdetailList}">
		<script>
			alert("게시글이 삭제되었습니다.");
			location.replace("/recruitMemBoardForm.do");
		</script>
	</c:if>
	...
	<c:if test="${!empty requestScope.memdetailList}">
		...
		<center>
			<table align="center" bordercolor="gray" border=1 cellpadding=7
				...
				<tr>
					...
					<!-- 상세보기할 게시판의 이름 표현하기 -->
					<!--------------------------------------------------- -->
					<td>${requestScope.memdetailList.writer}</td>
				</tr>
				<tr>
					...
					<!-- 상세보기할 게시판의 제목 표현하기 -->
					<!--------------------------------------------------- -->
					<td>${requestScope.memdetailList.title}</td>
				</tr>
				<tr>
					...
					<!-- 상세보기할 게시판의 조회수 표현하기 -->
					<!--------------------------------------------------- -->
					<td>${requestScope.memdetailList.readcount}</td>
				</tr>
				<tr>
					...
					<td><textarea name="content" class="content" rows="13"
							cols="40" maxlength="500" readonly>${requestScope.memdetailList.content}</textarea></td>
				</tr>
			</table>
		</center>
		...
		<center>
			...
			<span style="cursor: pointer"
				onclick=location.href="/recruitTeamBoardForm.do">
				[목록 화면으로] </span>
