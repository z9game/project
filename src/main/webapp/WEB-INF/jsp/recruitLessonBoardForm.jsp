...
<body>
    ...
    <div class="recruitLessonBoardFormContainer">
    	<div class="recruitLessonBoardFormConditionalSearch">
		...
		<div class="recruitLessonBoardFormBoard">
			<div class="newRecruitLessonBoardBtnDiv">
				<input type="button" class="newRecruitLessonBoardBtn" style="margin-top:50px;" value="새 글 쓰기" onClick="location.replace('/newRecruitLessonBoardForm.do')">
			</div>
