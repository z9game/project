...
<body>
    ...
    <div class="matchingFormContainer">
    	<div class="matchingFormConditionalSearch">
		...
		<div class="matchingFormBoard">
			<div class="newMatchingBoardBtnDiv">
				<input type="button" class="newMatchingBoardBtn" value="새 글 쓰기" onClick="location.replace('/newMatchingBoardForm.do')">
			</div>
