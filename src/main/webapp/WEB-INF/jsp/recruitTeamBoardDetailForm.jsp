...
<body>
	...
	<c:if test="${empty requestScope.teamdetailList}">
		<script>
			alert("게시글이 삭제되었습니다.");
		...
		<center>
			<table align="center" bordercolor="gray" border=1 cellpadding=7
				...
				<tr>
					...
					<!-- 상세보기할 게시판의 이름 표현하기 -->
					<!--------------------------------------------------- -->
					<td>${requestScope.teamdetailList.writer}</td>
				</tr>
				<tr>
					...
					<!-- 상세보기할 게시판의 제목 표현하기 -->
					<!--------------------------------------------------- -->
					<td>${requestScope.teamdetailList.title}</td>
				</tr>
				<tr>
					...
					<!-- 상세보기할 게시판의 조회수 표현하기 -->
					<!--------------------------------------------------- -->
					<td>${requestScope.teamdetailList.readcount}</td>
				</tr>
				<tr>
					...
					<td><textarea name="content" class="content" rows="13"
							cols="40" maxlength="500" readonly>${requestScope.teamdetailList.content}</textarea></td>
				</tr>
			</table>
		</center>
