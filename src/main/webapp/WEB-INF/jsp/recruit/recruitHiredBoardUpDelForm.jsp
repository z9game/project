...
<head>
<meta charset="UTF-8">
<title>recruitHiredBoardUpDelForm</title>
<link href="/style/recruitHiredBoardUpDelFormStyle.css" rel="stylesheet">
...
<script>
	...
	//------------------------------------------------------------------------
	// name='recruitHiredBoardUpDelForm" 를 가진 form 태그 관리 JQuery 객체 메위주 얻기 
	//------------------------------------------------------------------------
	var formObj = $("[name='recruitHiredBoardUpDelForm']");
	...
	//-----------------------------------------------------
		...
		$.ajax({
			url : "/recruitHiredBoardUpProc.do",
			type : "post",
	...
	function checkBoardDelForm() {
		...
		$.ajax({
			url : "/recruitHiredBoardDelProc.do",
			type : "post",
			data : formObj.serialize(),
			success : function(json) {
				var result = json["result"];
...
<body>
	...
	<div class="recruitHiredBoardUpDelFormTitle">
		<p class="titleBackgoundText">용병 모집 수정 / 삭제</p>
	</div>


	<form name="recruitHiredBoardUpDelForm">
