...
<script>
	...
	{
		//------------------------------------------------------------------------
		// name='newRecruitTeamMemBoardForm" 를 가진 form 태그 관리 JQuery 객체 메위주 얻기 
		//------------------------------------------------------------------------
		...
		<form name="newRecruitTeamMemBoardForm">
			<table class="newRecruitTeamMemBoardFormRegTable" border="1" bordercolor="black">
				...
				<tr>
					<th>요일</th>
					<td>
						<input type="checkbox" name="day" id="day" class="day" value="1">월
						<input type="checkbox" name="day" id="day" class="day" value="2">화
						<input type="checkbox" name="day" id="day" class="day" value="3">수
						<input type="checkbox" name="day" id="day" class="day" value="4">목
						<input type="checkbox" name="day" id="day" class="day" value="5">금
						<input type="checkbox" name="day" id="day" class="day" value="6">토
						<input type="checkbox" name="day" id="day" class="day" value="7">일
					</td>
				</tr>
				<tr>
					<th>시간</th>
				...
				<tr>
					<th>포지션</th>
					<td>
						<input type="radio" name="pos" class="pos" value="ST">ST
						<input type="radio" name="pos" class="pos" value="CM">CM
						<input type="radio" name="pos" class="pos" value="CB">CB
						<input type="radio" name="pos" class="pos" value="GK">GK
					</td>
				</tr>
				...
				<tr>
					<th>종류</th>
					<td>
						<input type="radio" name="team_mem" class="team_mem" value="팀">팀
						<input type="radio" name="team_mem" class="team_mem" value="팀원">팀원
					</td>
				</tr>
