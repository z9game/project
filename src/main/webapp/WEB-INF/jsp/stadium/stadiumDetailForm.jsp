    ...
    <c:if test="${!empty requestScope.stadiumDTO}">
        <table align="center" bordercolor="gray" border="1" cellpadding="7" style="border-collapse: collapse;">
            ...
            <tr>
                ...
                <td><textarea name="content" class="content" rows="13" cols="20" maxlength="50" readonly>${requestScope.stadiumDTO.content}</textarea></td>
            </tr>
        </table>
    </c:if>

    <table align="center" border="1" bordercolor="gray" cellpadding="7" style="border-collapse: collapse; margin-top: 20px;">
        <form action="/reserve" method="post">
            ...
            <tr>
                ...
                <td>
                    <select name="timeSlot" required="required">
                        <c:forEach var="time" items="${timeRanges}">
                            <option value="${time.timeNo}">${time.timeRange}</option>
                        </c:forEach>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2" style="text-align: center;"><input type="submit" value="예약하기"></td>
            </tr>
        </form>
    </table>
